...
parser.add_argument("--feat_dim", help="dimension of the output feature by DNN",
...
if __name__ == '__main__':
    ...
    layer_sizes1 = [512, outdim_size]
    layer_sizes2 = [512, outdim_size]
    ...
    [test_acc, valid_acc] = svm_classify(new_data, C=1)
